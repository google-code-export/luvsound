    ...
    return this.each(function(){
      ...
      $.getJSON(url, function(data){
        ...
        $.each(data.results, function(i,item){
          ...
          var date = '<span class="tweet_date"><a href="http://twitter.com/'+item.from_user+'/statuses/'+item.id+'" title="view tweet on twitter">'+relative_time(item.created_at)+'</a> | <a class="tweet_date" href="http://twitter.com/luvsound" title="follow us on twitter">follow us on twitter</a></span>';
