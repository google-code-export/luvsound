...
class FCKeditor
{
	 ...
	 */
	public $InstanceName ;
	public $DataName; /* DYSKE: name attribute of the input */
	/**
	...
	public function __construct( $instanceName )
 	{
		...
		$this->DataName = $instanceName; // DYSKE
		$this->BasePath		= '/js/' ;
		$this->Width		= '100%' ;
		$this->Height		= '400' ;
	...
	public function CreateHtml()
	{
		...
		if ( $this->IsCompatible() )
		{
			...
			$Html .= "<input type=\"hidden\" id=\"{$this->InstanceName}\" name=\"{$this->DataName}\" value=\"{$HtmlValue}\" style=\"display:none\" />" ;
		...
		else
		{
			...
			$Html .= "<textarea name=\"{$this->DataName}\" rows=\"4\" cols=\"40\" style=\"width: {$WidthCSS}; height: {$HeightCSS}\">{$HtmlValue}</textarea>" ;
		}
	...
	{
		return $this->IsCompatibleBrowser() ;
	}
